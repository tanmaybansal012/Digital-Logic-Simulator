...
*(Note: The simulator evaluates circuits strictly using the text-based netlist format. A visual drag-and-drop schematic editor is not currently functional/supported and is out of scope for the core engine).*
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
